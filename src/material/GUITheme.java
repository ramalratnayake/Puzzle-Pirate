...
public class GUITheme {
  ...
  private Border menuBorder = new DropShadowBorder (Color.BLACK, 0, 5, 0.3f, true, true, true, true);
  private Border defaultBorder = new DropShadowBorder (Color.BLACK, 5, 5, 0.3f, true, true, true, true);
  ...
  private static Font getFont (String fileName) {
	  System.out.println("looking for font");
    try {
